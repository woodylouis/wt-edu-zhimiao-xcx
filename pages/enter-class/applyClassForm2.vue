...
export default {
    ...
    methods: {
        ...
        async handleConfirm() {
            ...
            if (this.formData.role !== 'teacher') {
                ...
                uni.redirectTo({ url: `/pages/guardian/join?classCode=${encodeURIComponent(cacheData.code || '')}` });
                return;
            }
    ...
    async onLoad() {
        ...
        this.formData = {
            ...
            class_id: cacheData.classInfo && cacheData.classInfo._id,
            role: cacheData.role || 'teacher'
        };
